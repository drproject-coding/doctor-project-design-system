import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{P as r}from"./ProgressBar-C5VStynC.js";const L={title:"Components/ProgressBar",component:r,tags:["autodocs"],argTypes:{value:{control:{type:"range",min:0,max:100}},color:{control:"select",options:[void 0,"mint","pink","yellow","grey"]},size:{control:"select",options:[void 0,"sm","lg"]}}},a={args:{value:65}},s={args:{value:72,label:"Storage Used"}},o={args:{value:90,color:"mint",label:"Complete"}},l={args:{value:25,color:"pink",label:"Critical"}},n={args:{value:50,size:"sm"}},t={args:{value:80,size:"lg"}},c={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px",maxWidth:"400px"},children:[e.jsx(r,{value:85,label:"CPU Usage"}),e.jsx(r,{value:62,color:"mint",label:"Memory"}),e.jsx(r,{value:91,color:"pink",label:"Disk Space"}),e.jsx(r,{value:34,color:"yellow",label:"Network"})]})};var i,p,m;a.parameters={...a.parameters,docs:{...(i=a.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    value: 65
  }
